 ...
 */
package test.org.apache.kafka.clients.producer.internals;
...
public class DefaultPartitionerTest {
    ...
    public void setup()
    {
        HashMap<String,List<PartitionInfo>> map = new HashMap<>();
        map.put("test",partitions);
        cluster.setPartitionsByTopic(map);
    }
