...
public final class RecordMetadata {
    ...
    /**
     * convert from V3io RecordMetadata to Kafka RecordMetadata
     * @param vrecord RecordMetadata
     */
    public RecordMetadata(io.iguaz.v3io.streaming.client.api.RecordMetadata vrecord)
    {
        this.topicPartition = null;
        this.offset = vrecord.offset();
        this.timestamp = vrecord.timestamp();
        this.checksum = 0;
        this.serializedKeySize = vrecord.serializedKeySize();
        this.serializedValueSize = vrecord.serializedValueSize();
